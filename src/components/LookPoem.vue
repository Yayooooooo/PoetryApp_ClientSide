<template>
  <div id="app1" style="text-align: left;">
    <br><p style="font-size: 2.5rem"><b>On Crime and Punishment</b></p>
  <p>by Kahlil Gibran</p>
  <p style="font-size: larger;  "> It is when your spirit goes wandering upon the wind,<br>
    ...
    And that the corner-stone of the temple is not higher than the lowest stone in its foundation.<br>
  <br></p></div>
</template>
